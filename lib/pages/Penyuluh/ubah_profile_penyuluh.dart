...
class ubah_profile_penyuluh extends StatefulWidget {
  const ubah_profile_penyuluh({super.key});

  @override
  State<ubah_profile_penyuluh> createState() => _ubah_profile_penyuluhState();
}

class _ubah_profile_penyuluhState extends State<ubah_profile_penyuluh> {
  bool isView = true;
  bool isView2 = true;
