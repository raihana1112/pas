                ...
                children: [
                  ...
                  Column(
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => tentang_perusahaan()));
                        },
                        child: Container(
                            child: Padding(
                          padding: const EdgeInsets.all(15.0),
                  ...
                  Column(
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ketentuan_layanan()));
                        },
                        child: Container(
                            child: Padding(
                          padding: const EdgeInsets.all(15.0),
                  ...
                  Column(
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => kebijakan_privasi()));
                        },
                        child: Container(
                            child: Padding(
                          padding: const EdgeInsets.all(15.0),
